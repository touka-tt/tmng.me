...
if ((screen.width > 1000) ) {
{
    ...
    class Item {
        constructor(el) {
            ...
            this.DOM = {el: el};
            // the inner image
            this.DOM.image = this.DOM.el.querySelector('.case-img');
    ...
    class SmoothScroll {
        constructor() {
            ...
            if ($('.content').length) {
                [...this.DOM.content.querySelectorAll('.case-item')].forEach(item => this.items.push(new Item(item)));
            }
    ...
    const preloadImages = () => {
        return new Promise((resolve, reject) => {
            imagesLoaded(document.querySelectorAll('.case-img'), {background: true}, resolve);
        });
    };
